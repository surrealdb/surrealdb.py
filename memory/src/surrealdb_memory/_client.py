...
from surrealdb_memory._idempotency import idempotency_key
...
from surrealdb_memory._namespaces.entities import (
    AsyncEntities,
    BlockingEntities,
)
...
from surrealdb_memory._util import drop_none as _drop_none
        ...
        payload = _drop_none(
            {
                ...
                "scopes": _scope_sets(scopes) or None,
                "role": role,
