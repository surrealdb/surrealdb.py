...
class MemoryServiceError(Exception):
    """Base class for every error raised by the Memory SDK."""


class MemoryAPIError(MemoryServiceError):
...
class MemoryScopeError(MemoryAPIError):
...
_STATUS_CLASSES: dict[int, type[MemoryAPIError]] = {
    401: MemoryAuthError,
...
def error_for_status(
    ...
    *,
    ...
    cls = _STATUS_CLASSES.get(status_code, MemoryAPIError)
