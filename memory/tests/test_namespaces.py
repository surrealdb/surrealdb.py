...
@responses.activate
def test_traces_list_get_stats(client: Memory) -> None:
    responses.add(
        responses.GET,
        f"{ROOT}/traces",
        json={
...
@responses.activate
def test_lifecycle_decay_expire_fsck(client: Memory) -> None:
    responses.add(
...
@responses.activate
def test_sessions_lifecycle(client: Memory) -> None:
    responses.add(
        responses.POST,
        f"{ROOT}/sessions",
...
@responses.activate
def test_entities(client: Memory) -> None:
    responses.add(
        responses.GET,
        f"{ROOT}/entities",
        json={
...
@responses.activate
def test_keys(client: Memory) -> None:
    responses.add(
        responses.POST,
        f"{ROOT}/keys",
...
@responses.activate
def test_principals(client: Memory) -> None:
    responses.add(
        responses.GET,
        f"{ROOT}/principals",
...
@responses.activate
def test_scopes(client: Memory) -> None:
    responses.add(
        responses.POST,
        f"{ROOT}/scopes",
