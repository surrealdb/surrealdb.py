...
@responses.activate
def test_consolidate_posts_dry_run(client: Memory) -> None:
    responses.add(
        responses.POST,
...
@responses.activate
def test_audit_gets_with_filters(client: Memory) -> None:
    responses.add(
        responses.GET,
...
@responses.activate
def test_reflect_posts_query(client: Memory) -> None:
    responses.add(
        responses.POST,
...
@responses.activate
def test_elaborate_posts_optional_body(client: Memory) -> None:
    responses.add(
        responses.POST,
...
@responses.activate
def test_inspect_returns_raw_payload(client: Memory) -> None:
    responses.add(
        responses.GET,
...
@responses.activate
def test_query_context_posts(client: Memory) -> None:
    responses.add(
        responses.POST,
...
@responses.activate
def test_state_whoami_profile(client: Memory) -> None:
    responses.add(
        responses.GET,
...
@responses.activate
def test_health_is_not_context_scoped(client: Memory) -> None:
