...
/// Signs out of the database in an async manner.
/// 
/// # Arguments
/// * `Connection`: the connection to be signed out of
pub async fn invalidate(connection: WrappedConnection) -> Result<String, String> {
