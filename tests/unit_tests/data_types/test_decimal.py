...
def test_decimal_with_precision_encode():
...
def test_negative_decimal_encode():
...
def test_decimal_with_precision_decode():
...
def test_decimal_in_list_roundtrip():
...
def test_decimal_in_dict_roundtrip():
