...
def test_bound_excluded_equality():
...
def test_bound_types_not_equal():
...
def test_range_with_excluded_bounds():
...
def test_range_with_mixed_bounds():
...
def test_bound_included_encode():
...
def test_bound_excluded_encode():
...
def test_bound_included_decode():
...
def test_bound_excluded_decode():
...
def test_bound_included_roundtrip():
...
def test_bound_excluded_roundtrip():
...
def test_range_in_object_roundtrip():
...
@pytest.mark.asyncio
async def test_range_inclusive_db_roundtrip(surrealdb_connection):
...
@pytest.mark.asyncio
async def test_range_exclusive_db_roundtrip(surrealdb_connection):
...
@pytest.mark.asyncio
async def test_range_mixed_bounds_db_roundtrip(surrealdb_connection):
...
@pytest.mark.asyncio
async def test_string_range_db_roundtrip(surrealdb_connection):
...
@pytest.mark.asyncio
async def test_multiple_ranges_db_roundtrip(surrealdb_connection):
