...
@pytest.mark.asyncio
async def test_delete_string(async_http_connection, record_id):
...
@pytest.mark.asyncio
async def test_delete_record_id(async_http_connection, record_id):
    await async_http_connection.query("DELETE user;")
    await async_http_connection.query("CREATE user:tobie SET name = 'Tobie';")
...
@pytest.mark.asyncio
async def test_delete_table(async_http_connection):
    await async_http_connection.query("DELETE user;")
    await async_http_connection.query("CREATE user:tobie SET name = 'Tobie';")
