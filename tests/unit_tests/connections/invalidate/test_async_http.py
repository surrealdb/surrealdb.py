...
@pytest.fixture
async def main_connection(async_http_connection):
...
@pytest.mark.asyncio
async def test_invalidate_with_guest_mode_on(main_connection, secondary_connection):
    """
...
@pytest.mark.asyncio
async def test_invalidate_test_for_no_guest_mode(main_connection, secondary_connection):
    """
