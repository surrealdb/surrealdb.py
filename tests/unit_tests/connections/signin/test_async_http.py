...
async def setup_schema(
    ...
    await async_http_connection.query_raw("DELETE user;")
    await async_http_connection.query_raw("REMOVE TABLE user;")
    ...
    await async_http_connection.query_raw("REMOVE ACCESS user ON DATABASE;")
    await async_http_connection.query(
