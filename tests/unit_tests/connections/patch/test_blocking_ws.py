...
def test_patch_string_with_data(blocking_ws_connection, patch_data, setup_user):
...
def test_patch_record_id_with_data(blocking_ws_connection, patch_data, setup_user):
    record_id = RecordID("user", "tobie")
...
def test_patch_table_with_data(blocking_ws_connection, patch_data, setup_user):
    table = Table("user")
    record_id = RecordID("user", "tobie")
